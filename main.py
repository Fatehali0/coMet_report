...
# Path to current directory: mvtec_ad_2/mvtec_ad_2/
...
# Try importing modules in same folder
try:
    import backbones
    import common
    import metrices
    ...
    print(f"Checked path: {current_dir}")
    print(f"Files in folder: {os.listdir(current_dir)}")
    sys.exit(1)
