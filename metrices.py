...
def compute_pixelwise_retrieval_metrics(anomaly_segmentations, ground_truth_masks):
    ...
    optimal_threshold = pr_thresholds[np.argmax(F1_scores[:-1])]  # Adjust index since F1_scores has one more element
...
def compute_pro(masks, amaps, num_th=200):
    ...
    # Return PRO score along with dataframe for potential additional analysis
    return pro_auc, df